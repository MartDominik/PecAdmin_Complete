...
<!-- https://mdbootstrap.com/docs/standard/extended/login/#section-4 -->
                ...
                <div class="card kartya_stilus" style="border-radius: 1rem; ">
                    <div class="row g-0">
                        <div class="col-md-5 col-lg-5 d-none d-md-block">
                            <img src="images\allo_dobo_sajat1_vagott.jpg" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem; height: 100%;" />
                        </div>
                        <div class="col-md-1 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Regisztráció</h5>
